...
if(!file.exists("../reduce_analysis_output/REDUCE_Weibull_Models_20220218.rdata")){
...
save(gap.model, cal.model,
     file = "../reduce_analysis_output/REDUCE_Weibull_Models_20220218.rdata")
}else load("../reduce_analysis_output/REDUCE_Weibull_Models_20220218.rdata")
```
