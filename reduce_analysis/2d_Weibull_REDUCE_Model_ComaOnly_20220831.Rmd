...
load(file = "../reduce_data/processed_data_coma_2mgonly.rdata")
df2 <- df2 %>% ungroup %>%
...
if(!file.exists("../reduce_analysis_output/REDUCE_Weibull_Models_ComaOnly_20220831.rdata")){
...
save(gap.model, cal.model,
     file = "../reduce_analysis_output/REDUCE_Weibull_Models_ComaOnly_20220831.rdata")
}else load("../reduce_analysis_output/REDUCE_Weibull_Models_ComaOnly_20220831.rdata")
```
