...
if(!file.exists("../reduce_analysis_output/REDUCE_Weibull_Models_20220201.rdata")){
#############################
...
```{r}
m1 <-dplyr::select(cal.model$summary.table, Parameter, Estimate, Estimate.SE)
m2 <-dplyr::select(cal.model$initialization$summary.table1, Parameter, Estimate, Estimate.SE)
m3 <-dplyr::select(cal.model$initialization$summary.table2, Parameter, Estimate, Estimate.SE)
m4 <-dplyr::select(gap.model$summary.table, Parameter, Estimate, Estimate.SE)
m5 <-dplyr::select(gap.model$initialization$summary.table1, Parameter, Estimate, Estimate.SE)
m6 <-dplyr::select(gap.model$initialization$summary.table2, Parameter, Estimate, Estimate.SE)
tab.start <- 
