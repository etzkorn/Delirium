...
```{r, eval=FALSE}
if(!file.exists("../reduce_analysis/REDUCE_Spline_Models.rdata")){
model2a <-
frailtyPenal(data = df2,
	 formula = Surv(tstart, tstop, delirium) ~  treatment + cluster(id) +terminal(death),
	 formula.terminalEvent = ~ treatment,
	 recurrentAG = T,
	 n.knots = 8, 
	 kappa = c(10,10), 
...
multivPenal(formula = Surv(tstart, tstop, delirium) ~ treatment +
	...
	jointGeneral = F,
	hazard = "Splines",
	n.knots = as.integer(8),
	kappa = c(10000,10000,10000),
	maxit = 350, 
	save.progress = T,
	initialize = F,
	init.hazard = c(model2a$b[1:20],model2b$b[11:20])^2,
	init.Theta = 25,
	init.Alpha1 = 0.53,
	init.Alpha2 = -1,
	init.B = c(0.02, 0.03395009, 0.06486052),
	GHpoints =  20)
save(model2a, model2b, model2c,
