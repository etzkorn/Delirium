---
title: "Simulation of Competing Joint Model (Gap Times)"
...
$$
    ...
    \eta_r = 80, \eta_1 = 20, \eta_2 = 10 \text{  (weibull scale)}\\
...
set.seed(031821)
par00 = c(betaR = 1, etaR = 80,
         betaD = 1, etaD = 20,         
         betaD2 = 1, etaD2 = 10,
         theta = 0.44, alpha1 = -1, alpha2 = -1,
...
####################################################################
# Generate Data
if(!file.exists("../package_test_output/CompetingJointModels_20210722.rdata")){
data0 <- 
map(par0, 
...
save(data0, mod.joint.a, file = "../package_test_output/CompetingJointModels_20210722.rdata")
}
} else load(file = "../package_test_output/CompetingJointModels_20210722.rdata")
```
